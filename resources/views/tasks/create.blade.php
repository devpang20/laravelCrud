...
@section('content')
    <div class="px-64">
        ...
        <form action="/tasks" method="POST">
            ...
            <textarea class="border border-gray-800 w-full @error('body') border border-red-700 @enderror" name="body" id="body" cols="30" rows="10" required value="{{ old('body') ? old('body') : '' }}"></textarea>
            @error('body')
                <small class="text-red-700"> {{ $message }} </small>
            @enderror
            <br>
